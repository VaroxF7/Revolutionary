...
StartupEvents.registry('item', e => {
     ...
     e.create("platinum_clump")
     e.create("ruthenium_clump")
     e.create("palladium_clump")
     e.create("rhodium_clump")
...
StartupEvents.registry('item', e => {
    e.create("drone_chassi").displayName("Drone Chassi")
    ...
    e.create("circuit_scrap").displayName("Circuit Scrap")
    e.create("processor_scrap").displayName("Processor Scrap")
    e.create("metal_scrap").displayName("Metal Scrap")
...
StartupEvents.registry('block', event => {
    event.create('energized_steel_coil_block','gtceu:coil')
         ...
         .tier(2)
         .energyDiscount(4) 
         //.texture('gtceu:block/casings/coils/placeholder_coil')
         .hardness(5)
         .requiresTool(true)
         .soundType(SoundType.NETHERITE_BLOCK)
