...
ServerEvents.recipes(e => {
     const toRemoveId = [
       'createaddition:crafting/electrum_ingot','botania:mana_infusion/manasteel',
       'ad_astra/alloying/steel_ingot_from_alloying_iron_ingot_and_coals','gtceu:shaped/cleanroom'
     ];
