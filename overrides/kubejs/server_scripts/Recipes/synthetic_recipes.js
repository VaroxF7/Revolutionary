...
// Nether Star
ServerEvents.recipes(e => {
  e.recipes.gtceu.large_chemical_reactor("nether_star_helium")
   .itemInputs("4x gtceu:iridium_dust")
   .inputFluids([Fluid.of("gtceu:helium_3", 1000)])
   .outputFluids([Fluid.of("gtceu:liquid_nether_star", 144)])
   .duration(340).EUt(2048)
})
