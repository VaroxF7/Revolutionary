...
e.recipes.create.mixing(["4x kubejs:kelp_fiber"],["minecraft:kelp","gtceu:stone_dust"])
e.recipes.create.mixing(["kubejs:compound_base"],["2x kubejs:kelp_fiber","#forge:nuggets"])

// Electrical Starts Stuff
e.recipes.create.sequenced_assembly([Item.of("kubejs:early_electronic_circuit")],"create:precision_mechanism",[
  e.recipes.create.deploying('create:precision_mechanism',['create:precision_mechanism','gtceu:fine_copper_wire']),
  e.recipes.create.deploying('create:precision_mechanism',['create:precision_mechanism','gtceu:resin_printed_circuit_board']),
  e.recipes.create.deploying('create:precision_mechanism',['create:precision_mechanism','tconstruct:obsidian_pane']),
  e.recipes.create.deploying('create:precision_mechanism',['kubejs:early_electronic_circuit','kubejs:energized_bolt']),
]).transitionalItem("create:precision_mechanism").loops(1)

e.recipes.create.pressing(["kubejs:rusty_chip"],["kubejs:early_electronic_circuit"])

e.custom({
    "type":"createaddition:charging",
    "input": {
          "item": "gtceu:electrum_bolt",
      "count": 1
    },
    "result": {
      "item": "kubejs:energized_bolt",
      "count": 1
    },
    "energy": 4000,
    "maxChargeRate": 200
...
e.shaped('gtceu:coke_oven', [
      ...
      }).damageIngredient('#forge:tools/wrenches',1)
...
}).damageIngredient('#forge:tools/screwdrivers',1).damageIngredient('#forge:tools/hammers',1)
})
