...
// Wafer Cleaning & Solution Recipe
ServerEvents.recipes(e => {
     // Silicon Wafer
     e.recipes.gtceu.chemical_bath("cleaning_1")
     .itemInputs("kubejs:dirty_silicon_wafer")
     .itemOutputs("gtceu:silicon_wafer")
     .inputFluids([Fluid.of("gtceu:cleaning_solution", 144)])
     .duration(100).EUt(15).cleanroom(CleanroomType.CLEANROOM)

     e.recipes.gtceu.chemical_bath("cleaning_2")
     .itemInputs("kubejs:dirty_silicon_wafer")
     .itemOutputs("gtceu:silicon_wafer")
     .inputFluids([Fluid.of("gtceu:distilled_water", 576)])
     .duration(200).EUt(15).cleanroom(CleanroomType.CLEANROOM)

     // Phosphorus Wafer
     e.recipes.gtceu.chemical_bath("cleaning_3")
     .itemInputs("kubejs:dirty_phosphorus_wafer")
     .itemOutputs("gtceu:phosphorus_wafer")
     .inputFluids([Fluid.of("gtceu:cleaning_solution", 144)])
     .duration(100).EUt(15).cleanroom(CleanroomType.CLEANROOM)

     e.recipes.gtceu.chemical_bath("cleaning_4")
     .itemInputs("kubejs:dirty_phosphorus_wafer")
     .itemOutputs("gtceu:phosphorus_wafer")
     .inputFluids([Fluid.of("gtceu:distilled_water", 576)])
     .duration(200).EUt(15).cleanroom(CleanroomType.CLEANROOM)
     ...
     // Naquadah Wafer
     e.recipes.gtceu.chemical_bath("cleaning_5")
     .itemInputs("kubejs:dirty_naquadah_wafer")
     .itemOutputs("gtceu:naquadah_wafer")
     .inputFluids([Fluid.of("gtceu:cleaning_solution", 144)])
     .duration(100).EUt(15).cleanroom(CleanroomType.CLEANROOM)

     e.recipes.gtceu.chemical_bath("cleaning_6")
     .itemInputs("kubejs:dirty_naquadah_wafer")
     .itemOutputs("gtceu:naquadah_wafer")
     .inputFluids([Fluid.of("gtceu:distilled_water", 576)])
     .duration(200).EUt(15).cleanroom(CleanroomType.CLEANROOM)
     ...
     // Neutronium Wafer
     e.recipes.gtceu.chemical_bath("cleaning_7")
     .itemInputs("kubejs:dirty_neutronium_wafer")
     .itemOutputs("gtceu:neutronium_wafer")
     .inputFluids([Fluid.of("gtceu:cleaning_solution", 144)])
     .duration(100).EUt(15).cleanroom(CleanroomType.CLEANROOM)

     e.recipes.gtceu.chemical_bath("cleaning_8")
     .itemInputs("kubejs:dirty_neutronium_wafer")
     .itemOutputs("gtceu:neutronium_wafer")
     .inputFluids([Fluid.of("gtceu:distilled_water", 576)])
     .duration(200).EUt(15).cleanroom(CleanroomType.CLEANROOM)
     ...
     // Solution Recipe
     e.recipes.gtceu.mixer("cleaning_solution")
      .itemInputs("2x gtceu:soapstone_dust","2x gtceu:sodium_dust")
      .inputFluids([Fluid.of("minecraft:water", 144)])
      .outputFluids([Fluid.of("gtceu:cleaning_solution", 576)])
      .duration(200).EUt(15)
})
