ServerEvents.recipes(e => {
    ...
    e.recipes.gtceu.chemical_reactor("refined_biofuel_three_oxide")
     ...
     .itemInputs("8x gtceu:salt_dust")
     .outputFluids([Fluid.of("kubejs:refined_biofuel", 200)])
     .duration(220).EUt(20)
        
    e.remove({ output: "gtceu:plant_ball"})
    e.remove({ output: "createaddition:biomass"})

    e.recipes.gtceu.combustion_generator("refined_biofuel_lv")
     .inputFluids([Fluid.of("kubejs:refined_biofuel", 4)])
     .EUt(32).duration(60)
})