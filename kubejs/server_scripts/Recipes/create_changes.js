ServerEvents.recipes(e => {
  ...
  e.recipes.create.mixing(["4x create:andesite_alloy"], ["kubejs:compound_base", Fluid.of("gtceu:tin", 144)]).heated()
  e.recipes.create.mixing(["4x create:andesite_alloy"], ["kubejs:compound_base", Fluid.of("gtceu:zinc", 144)]).heated()
  e.recipes.create.mixing(["12x create:andesite_alloy"], ["kubejs:compound_base", Fluid.of("gtceu:electrum", 144)]).superheated()
