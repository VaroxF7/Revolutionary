...
ServerEvents.recipes(e => {
     const toRemoveId = [
       ...
       'gtceu:packer/unpackage_captinium_tiny_dust','notreepunching:clay_brick_from_balls','notreepunching:clay_brick_from_blocks','gtceu:shaped/coke_oven_hatch','gtceu:shaped/coke_oven',
